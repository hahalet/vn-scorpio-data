...
public class CalendarReminderUtils {
    ...
    public static String CALENDARS_NAME = "nscalendar";
    public static String CALENDARS_ACCOUNT_NAME = "nscalendar@gmail.com";
    public static String CALENDARS_ACCOUNT_TYPE = "ACCOUNT_TYPE_LOCAL";
    public static String CALENDARS_DISPLAY_NAME = "nscalendar";
     ...
     * @return List
     */
    public static List<Map<String, String>> queryCalendars(Context context){
        int id = checkCalendarAccount(context);
        List<Map<String, String>> calendars = new ArrayList<>();

        Cursor cursor = null;
        cursor = context.getContentResolver().query(Uri.parse(CALENDER_EVENT_URL), null,
                null, null, null);
        while (cursor.moveToNext()) {
            Map<String, String> calendar = new HashMap<String, String>();
            // Get the field values
            calendar.put(CalendarContract.Events.TITLE, cursor.getString(cursor.getColumnIndex(CalendarContract.Events.TITLE)));
            calendar.put(CalendarContract.Events.DESCRIPTION, cursor.getString(cursor.getColumnIndex(CalendarContract.Events.DESCRIPTION)));
